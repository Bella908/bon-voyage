...
const LogIn = () => {
  ...
  const handleGoogleLogin =() =>{
    googleLogin()
    .then(() => {
      // Login successful, handle redirection or other actions if needed
      console.log("Logged in successfully!");
      // setSuccess('User Crated SucessFully')
    })
    .catch((error) => {
      // Handle login error
          ...
          <div className=" flex flex-col items-center">
            ...
            <div className="w-full flex-1 mt-8">
              <div className="mx-auto max-w-xs flex flex-col gap-4">
                ...
                <a
            href="#"
            className=" flex items-center justify-center mt-4 bg-white text-white rounded-lg shadow-md hover:bg-gray-100"
          >
